...
--
-- Gép: 127.0.0.1
-- Létrehozás ideje: 2023. Feb 17. 17:13
...
-- Adatbázis: `mozi`
--
CREATE DATABASE IF NOT EXISTS `mozi` DEFAULT CHARACTER SET utf8mb4 COLLATE utf8mb4_hungarian_ci;
USE `mozi`;
...
CREATE TABLE `film` (
  `id` int(11) NOT NULL,
  `cim` varchar(64) COLLATE utf8mb4_hungarian_ci NOT NULL,
